            ...
            <form action="/update" method="get">
                <tr>
                    ...
                    <td>
                        ...
                        <a onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này khỏi giỏ hàng')" class="btn btn-danger" href="/remove/{{$obj->rowId}}">Remove</a>
                    </td>
                </tr>
            </form>
        @endforeach
...
<div class="row justify-content-end">
    <ul style="list-style-type: none">
        <li><a onclick="return confirm('Bạn có chắc muốn xóa hết giỏ hàng ?')" class="btn btn-danger" href="/destroy">Remove All</a></li>
        <li>Tax : {{\Gloudemans\Shoppingcart\Facades\Cart::tax()}}</li>
        <li>Total : {{\Gloudemans\Shoppingcart\Facades\Cart::total()}}</li>
    </ul>
</div>
</div>
</body>
